...
def main():
    ...
    red1 = pygame.image.load('test_images/background_1.png').convert()
    blue = pygame.transform.scale(pygame.image.load('test_images/background_2.png').convert(),
                                  (800, 800))
    ...
    while running:
        ...
        pygame.gfxdraw.textured_polygon(
            screen, triangy, red1, offx1[0], offx1[1])
        pygame.gfxdraw.textured_polygon(
            screen, triangy1, blue, offx2[0], offx2[1])
