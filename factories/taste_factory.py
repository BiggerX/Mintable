...
def taste_mint():
    ...
    while(count <= max_count):
        ...
        collection_title = 'Taste Series Token ' + str(count)
        collection_subtitle = 'Number ' + \
            str(count) + '/' + str(max_count) + ' Tokens'
        collection_description = 'Part ' + \
            str(count) + ' out of ' + str(max_count) + \
            ' in the Taste Series by Toxic Mushroom. Nature\'s patterns present themselves everywhere in our daily lives. This series captures the explosive beauty in colorized darkness.'
        token_price = '24'
        ...
        if not my_file.is_file():
            ...
            taste.main(
                file_name, "Taste " + str(count), 1200, 1200)
        else:
